#############################################################
# IDENTIFYING INTERACTIONS BETWEEN PROTIENS AND TRANSCRIPTS #
#############################################################
#
# Introduction:
#----------------
...
#
# give this data frame a simple name for later and convert to a matrix
#
rime <- as.matrix(rime_lfcs_p)
#
# save a copy of 'rime' as .csv file
#
write.csv(rime, file = "results/DE_results.csv")
#
#########################################################################
#
# Import RNA-seq data:
